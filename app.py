# ==========================================
# 2. UPDATED: PINTEREST SEARCH ENDPOINT (15 Results with Video Support)
# ==========================================
...
def search_pins():
    ...
    try:
        # Vercel API se top 15 results mangwana
        ...
        if "items" in response and len(response["items"]) > 0:
            ...
            # Loop chalana 15 results ke liye (Aapka bot limits 10 tak sambhal lega)
